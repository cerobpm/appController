...
app.get('/start/:appname',auth.isAdmin,(req,res)=>{
    controller.startApp(req.params.appname)
	.then(result=>{
...
app.get('/apps',auth.isAdmin,(req,res)=>{
	controller.checkAppAll()
	.then(result=>{
...
app.get('/usuarios/:username',auth.isAuthenticated, (req,res)=>{ 
	userAdmin.viewUser(req,res)
})

app.get('/usuarios',auth.isAdmin, (req,res)=>{ 
	userAdmin.viewUsers(req,res)
})

app.get('/usuarionuevo',auth.isAdmin,(req,res)=>{
